...
- (Experimental) Change to be able to receive the current node instance as the `_node_` keyword argument of the callables (matcher, caller, terminator) specified in the builder style.
